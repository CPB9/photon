...
macro(photon_link_device_tests dev)
    target_link_libraries(test-udpserver-${dev} ${ARGN})
    target_link_libraries(test-perf-${dev} ${ARGN})
    target_link_libraries(test-inproc-${dev} ${ARGN})
    target_link_libraries(fwt-test-${dev} ${ARGN})
endmacro()
